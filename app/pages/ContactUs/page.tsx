...
const page = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#5D1725] text-white text-center py-8 px-4 h-[70vh] text-xl flex flex-col items-center justify-center xl:container container md:max-w-4xl max-w-md rounded-md mx-auto w-8/10">
