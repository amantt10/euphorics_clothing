      ...
      <div className="w-full flex flex-col items-center my-8 px-4">
        ...
        <div className="w-full max-w-2xl p-4 bg-gray-50 rounded-lg shadow">
          {activeTab === 'biography' && (
            <div>
              <p>
              As a student of the MSState rehabilitation counseling master's program, I am actively continuing my education in the field of rehabilitation. This combined with work experiences and personal experiences with disability may help me in considering alternative perspectives of vocational rehabilitation.
          ...
          {activeTab === 'education' && (
            <div className="px-2 md:px-6">
              <ul className="list-disc pl-6 md:pl-8">
                <li>Mississippi State University 2019-2023</li>
