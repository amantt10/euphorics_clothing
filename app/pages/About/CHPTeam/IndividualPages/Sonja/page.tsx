      ...
      <div className='flex flex-col md:flex-row items-center justify-center gap-8 mb-10 px-4'>
        ...
        <div className='flex flex-col gap-4 w-full max-w-md'>
          ...
          <div>
            ...
            <p>Vocational Counselor, CHP Service Region #4 Central </p>
          </div>
          <div>
      ...
      <div className="w-full flex flex-col items-center my-8 px-4">
        ...
        <div className="w-full max-w-2xl p-4 bg-gray-50 rounded-lg shadow">
          {activeTab === 'biography' && (
            <div>
              <p>
              I was drawn to human service because of my desire to help others and make a positive impact in the world. I find purpose in tackling challenging issues, advocating for vulnerable populations and empowering them to overcome adversity. <br/><br/>
 
Human Service field cover the areas of social work, counseling and case management. Considering my experience and time spent in the Human Service field, I believe that I will serve well in the position of Vocational Counselor in the effort of providing support and resources to help people overcome obstacles. 
