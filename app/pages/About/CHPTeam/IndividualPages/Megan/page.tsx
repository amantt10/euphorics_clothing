  ...
  return (
    <>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center gap-8 mb-10 px-4'>
        <img
          src="/members/Megan.jpg"
          alt="Megan Williamson"
        ...
        <div className='flex flex-col gap-4 w-full max-w-md'>
          ...
          <div>
            ...
            <p>Vocational Counselor, CHP Service Region #3 Delta </p>
          </div>
          <div>
      ...
      <div className="w-full flex flex-col items-center my-8 px-4">
        ...
        <div className="w-full max-w-2xl p-4 bg-gray-50 rounded-lg shadow">
          {activeTab === 'biography' && (
            <div>
              <p>
              Megan Williamson is excited to be part of the Career Horizons Project. She brings a degree in Marketing from the University of Mississippi combined with a history of employment placements and volunteer services with persons with an array of disabilities. Megan says, "when I found out about this amazing position, I knew it was the right fit to integrate my degree and my lifelong passion for serving and supporting persons with disabilities."
