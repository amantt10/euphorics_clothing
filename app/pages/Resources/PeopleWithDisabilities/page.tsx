    ...
    <>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-8">
        ...
        Refer Yourself to the Career Horizons Project: 
          ...
          <p className="text-lg  text-gray-600 mb-8">
          Do you have an interest in working but have had to stop working or are struggling to maintain employment due to a disability accompanied by or resulting from Long COVID? If so, complete our <Link href='/pages/Referral/' className="font-semibold underline" aria-label="self referral form">
          Self-referral
            </Link> Form and refer yourself to the Career Horizons Project for competitive integrative employment (CIE) placement or retention services.   
          </p>
        </div>
